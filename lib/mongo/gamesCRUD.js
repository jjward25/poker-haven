  ...
  try {
    ...
    const newGame = {
      ...
      settings: {
        ...
        realDollarMultiplier: gameData.settings?.realDollarMultiplier || 0.01,
        allowPlayersToInvite: gameData.settings?.allowPlayersToInvite || false,
        gameCaptains: gameData.settings?.gameCaptains || []
      }
    };
